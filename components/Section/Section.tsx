...
function Icon({children, color}:any) {
    return (
    <motion.div 
    className={` text-[${color}] text-[1.0rem] p-[5px] mx-4 hover:bg-white rounded-md ${center} flex-col h-[30%] w-[20%]`}
    ...
    case 2:
        return(
            ...
            <div className=' flex justify-center items-center h-screen w-full bg-white'>
                <div className=' grid sm:grid-cols-2 grid-cols-1 h-[100%] sm:w-[90%] sm:h-[90%]  w-[100%] bg-white'>
                    <div className='mb-4 flex flex-col justify-evenly items-center h-[100%] w-full bg-white'>
                            <Image quality={100} width={150} height={150} src="https://imagedelivery.net/6i45l_k8v6cNrhGva7A6BA/cc8b4531-4beb-481a-e393-7543df549100/public" alt="" className='sm:h-[140px] sm:w-[130px] h-[100px] w-[90px] rounded-full bg-white'/>
                            <div className='bg-slate-100 p-4 sm:text-[14px] text-[12px] flex flex-col items-center justify-center w-[100%] h-[60%]'>
                                <p className='font-semibold'>이성근</p>
                    ...
                    <div className='flex justify-center items-center w-full bg-white'>
                            <div className='flex items-center justify-center sm:justify-evenly flex-col w-full h-[100%] bg-white rounded-md'>
                                ...
                                <div className='flex flex-col items-center font-bold'>
                                    ...
                                    <div className='flex flex-wrap w-full justify-around font-mono'>
                                        <Icon>Recoil</Icon>
                                        <Icon>ContextApi</Icon>
                                        <Icon>Redux</Icon>
                                        <Icon>FramerMotion</Icon>
                                        <Icon>Mysql</Icon>
                                    </div>
                                </div>
                                <div className='mb-12 flex items-center flex-col font-bold'>
                                    <div className='m-2 text-black'>협업</div>
                                    <div className='font-mono'>Pigma  GitHub  </div>
                                </div>
